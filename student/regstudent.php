...
{
 echo "<br>".$eno=$_POST['enno'];
  echo "<br>".$name=$_POST['name'];
  echo "<br>".$course=$_POST['course'];
  echo "<br>".$address=$_POST['address'];
  echo "<br>".$contact=$_POST['contact'];
  echo "<br>".$email=$_POST['email'];
  echo "<br>".$pass=$_POST['password'];

$query="insert into student (enno,password,name,course,address,contact,email) values ('$eno','$pass','$name','$course','$address','$contact','$email')";
